...
namespace EasyChat.ViewModel
{
    public class LoginPageViewModel
    {
        ...
        public LoginPageViewModel(IUserService userService, IWebService webService)
        {
        ...
        public async Task<bool> LoginAsync(string name, string password)
        {
            ...
            {
                // 创建Json信息
                Send_LoginRegisterJson request = new Send_LoginRegisterJson("login", name, password);
                // 将该信息解析为Json
